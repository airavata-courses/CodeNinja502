...
Requirements: Java, JDK, JRE
 ...
 - Download the file "feed-fetch-service-0.0.4.jar" from https://github.com/airavata-courses/CodeNinja502/blob/Assignment-1/feed-fetch-service-0.0.4.jar and run it.
